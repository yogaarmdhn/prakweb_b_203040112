...
<body id="home" class="scrollspy">
    ...
    <nav class="place c2" style="background-color: #eceff1 ;">
      <div class="container">
        <div class="nav-wrapper">
          <a href="#home" class="brand-logo" style="color: black;">Iqro</a>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col s6 light">
          <h5><img src="assets/img/book.svg" alt="">Iqro</h5>
          <p>Iqro yang diambil dari bahasa Arab yang artinya Baca. Iqro yaitu Website yang berisi buku-buku rekomendasi yang menarik,
          ...
          <div class="card-panel center white lighten-3">
            <div class="row">
              ...
              <div class="col m4 s12">
                ...
                <p>203040112@mail.unpas.ac.id</p>
              </div>
  ...
  <footer class="light center">
    <p class="footer_tittle" style="font-size: 2rem; margin-bottom: 10px;">Agoy Present </p>
    <div class="footer_social" style="font-size: 3.5rem; color: #fff; margin-top: 10px; margin-bottom: 20px;">
      <a href="https://www.facebook.com/yogaarmdhn/" target="_blank"><img src="https://img.icons8.com/metro/26/000000/facebook-new--v2.png" /></a>
      <a href="https://www.instagram.com/yogaarmdhn/" target="_blank"><img src="https://img.icons8.com/metro/26/000000/instagram-new.png" /></a>
      <a href="https://www.twitter.com/yogaarmdhn" target="_blank"><img src="https://img.icons8.com/metro/26/000000/twitter.png" /></a>
      <a href="https://wa.link/po0zqg" target="_blank"><img src="https://img.icons8.com/fluent-systems-filled/24/000000/whatsapp.png" /></a>
    </div>
    <p>Copyright &copy; 2022 - Yoga Bagja Ramadhan.</p>
  </footer>
